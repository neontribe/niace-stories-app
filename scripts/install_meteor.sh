#!/bin/sh
# THIS HAS BEEN MANUALLY COPY/PASTED FROM INSTALL.METEOR.COM (16/10/2015)
# The script started 404'ing on travis boxes today
# (first failed build for this app was on that day)
# this is just for the travis box
